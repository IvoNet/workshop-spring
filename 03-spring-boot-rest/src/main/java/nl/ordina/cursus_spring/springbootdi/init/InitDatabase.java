...
package nl.ordina.cursus_spring.springbootdi.init;
...
public class InitDatabase {
    ...
    public InitDatabase(final WaardenRepository waardenRepository) {
    ...
    private void init() {
        ...
        final List<Waarden> waardens = new ArrayList<>(100);
        for (long i = 0; i < 100; i++) {
            waardens.add(new Waarden(random.nextInt()));
        }
        Collections.shuffle(waardens);
        this.waardenRepository.saveAll(waardens);
    }
}
